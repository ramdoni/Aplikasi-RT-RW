...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      <h1 class="text-danger" style="font-size: 50px;line-height: 1px;" >Registrasi Berhasil</h1>
    <footer class="footer text-center"><?=date('Y')?> &copy; Kodami Pocket System.</footer>
      <p class="text-muted m-t-30 m-b-30">Silahkan cek email anda, untuk melihat detail pendaftaran.</p>
