        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="last-nav"><a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-account-card-details fa-fw"></i> <span class="hide-menu">From Pengajuan<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="{{ route('warga.surat-pengantar-domisili.index') }}" class="waves-effect"><i class="mdi mdi-file-document-box fa-fw"></i> <span class="hide-menu">Surat Pengantar Domisili</span></a></li>
                            <li> <a href="{{ route('warga.surat-pengantar-rt.index') }}" class="waves-effect"><i class="mdi mdi-file-document-box fa-fw"></i> <span class="hide-menu">Surat Pengantar RT</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
