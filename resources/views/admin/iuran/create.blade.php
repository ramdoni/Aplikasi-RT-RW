    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="white-box">
                ...
                <br />
                <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('admin.iuran.store') }}" method="POST">
                    <div class="col-md-6">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" required placeholder="Rp. " name="nominal"> </div>
                        </div>
                        <hr />
