                                                ...
                                                @if($chekIuran)
                                                    <div class="btn-group m-r-10">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="{{ route('admin.iuran-warga.bayar-rollback', ['id' => $chekIuran->id]) }}" onclick="return confirm('Proses Pembayaran ini ?')" class="text-success" style="color: red !important;"><i class="fa fa-check"></i> Belum Lunas</a></li>
                                                        </ul>
                                                    </div><br />
...
<div class="modal fade" id="modal_belum_lunas" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form method="POST" action="{{ route('admin.iuran-warga.bayar') }}" id="proses_pembayaran">
            {{ csrf_field() }}            
