...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="white-box">
                <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('admin.pengeluaran.store') }}" method="POST">
                    <div class="col-md-6">
                        {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="pengeluaran_type_id">
                                    @foreach(pengeluaran_type() as $item)
                        ...
                        <hr />
                        <a href="{{ route('admin.pengeluaran.index') }}" class="btn btn-default btn-sm waves-effect waves-light m-r-10">Cancel</a>
