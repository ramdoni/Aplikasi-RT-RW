    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <a href="{{ route('admin.pengeluaran.create') }}" class="btn btn-info btn-sm pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus"></i> TAMBAH PENGELUARAN</a>
                <ol class="breadcrumb">
                                    ...
                                    <td>    
                                        <div class="btn-group m-r-10">
                                            ...
                                            <ul role="menu" class="dropdown-menu">
                                                <li><a href="{{ route('admin.anggota.edit', ['id' => $item->id]) }}"><i class="ti-pencil-alt"></i> Edit</a></li>
