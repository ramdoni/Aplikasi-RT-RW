    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="white-box">
                ...
                <br />
                <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('bank.update', $data->id) }}" method="POST">
                    <div class="col-md-6">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <img src="{{ asset('bank/'. $data->image) }}" style="width: 200px;" />
                            </div>
                        </div>
                        <a href="{{ route('bank.index') }}" class="btn btn-inverse waves-effect waves-light m-r-10">Cancel</a>
