...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">FORM RUKUN TETANGGA</h3>
                <hr />
                <form class="form-horizontal" action="{{ route('admin.rt.update', $data->id) }}" method="POST" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-12">RUKUN WARGA</label>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-12">NO RUKUN TETANGGA</label>
                            <div class="col-md-6">
                                <input type="number" class="form-control" name="no" value="{{ $data->no }}" /> 
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody class="tr-pengurus">
                                    @foreach($data->pengurus as $no => $item)
                                    <tr>
                                        <td>{{ $no+1 }}</td>
