    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <a href="{{ route('rt.pengeluaran-type.create') }}" class="btn btn-info btn-sm pull-right m-l-20 waves-effect waves-light"> <i class="fa fa-plus"></i> TAMBAH JENIS PENGELUARAN</a>
                <ol class="breadcrumb">
