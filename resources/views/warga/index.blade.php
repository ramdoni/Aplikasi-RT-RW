                    ...
                    <div class="p-30">
                        ...
                        <div class="row text-center m-t-30">
                            ...
                            <div class="col-xs-4 b-r">
                                ...
                                <h4>Rp. 0</h4>
                                <a href="{{ route('warga.simpanan-sukarela.index') }}" class="btn btn-default btn-xs"><i class="fa fa-search-plus"></i> detail</a>
                            </div>
                            <div class="col-xs-4 b-r">
                        ...
                        <div class="steamline">
                            <div class="sl-item">
                                ...
                                <div class="sl-right">
                                    ...
                                    <div class="desc">
                                        <form method="POST" action="{{ route('warga.index.save.profile') }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="col-md-6">
                                                <div>
                            ...
                            <div class="sl-item">
                                ...
                                <div class="sl-right">
                                    <form action="{{ route('warga.submit-step1') }}" method="POST">
                                    {{ csrf_field() }}
